        ...
        public DataView OraGetAll(int flag)
        {
            switch (flag)
            {
                ...
                case 4://Getting the list of pending Tests(currently for CBC)
                    ...
                    break;
                case 5://Getting the list of pending Tests(Machine Name:Architect 8000)
                    objdbMI.Query = @"SELECT lt.labid,wm_Concat(lt2.DSerialNo) DSerialNOs,
                                 ...
                                 WHERE lt2.processid = '0004'
                                   AND ltm.methodid = '0126'
                                    or ltm.methodid = '0128'
                                   ...
                                   and (lt2.Ordered != 'Y' or lt2.ordered is null)
