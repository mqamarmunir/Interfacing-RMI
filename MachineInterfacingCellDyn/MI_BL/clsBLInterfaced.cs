...
namespace MI_BL
{
    public class clsBLInterfaced
    {
        ...
        private string _MethodID = _Default;
        ...
        public bool updateinterfaced()
        {
            if (ValidateData())
            {
                objMI.Query = "update ls_tinterfaced set value='"+_Value+"',methodid='"+_MethodID+"' where mserialno=" + _MSerialNo + " and interfaceid='" + _Interfaceid + "'";
                StrErr = _objConnection._objOperation.DataTrigger_OraUpdate(objMI);
                if (_StrErr.Equals("Error"))
                {
                    _StrErr = _objConnection._objOperation.OperationError;
        ...
        public DataView GetAllOra(int flag)
        {
            switch (flag)
            {
                case 1: //Result to upload
                    ...
                    break;
                case 2:
                    objMI.Query = "Select * From ls_tinterfaced where mserialno=" + _MSerialNo + " and interfaceid='" + _Interfaceid + "'";
                    break;
            }
        ...
        {
            string[,] arrInterfaced = new string[4, 3];
            ...
            if (!_MethodID.Equals(_Default))
            {
                arrInterfaced[3, 0] = "methodid";
                arrInterfaced[3, 1] = _MethodID;
                arrInterfaced[3, 2] = "string";
            }
